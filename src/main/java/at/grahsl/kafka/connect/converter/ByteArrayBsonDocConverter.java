...
import at.bronzels.libcdcdw.util.MyObj;

import org.apache.kafka.connect.data.Schema;
import org.apache.kafka.connect.errors.DataException;
import org.bson.*;

public class ByteArrayBsonDocConverter implements RecordConverter {
    ...
    public BsonDocument convert(Schema schema, Object value) {
        ...
        return (BsonDocument) MyObj.deserialize((byte[])value);
