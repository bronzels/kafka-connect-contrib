...
import at.grahsl.kafka.connect.processor.field.projection.WhitelistProjector;
...
public class WhitelistValueProjector extends WhitelistProjector {
    ...
    public WhitelistValueProjector(SinkConnectorConfig config, String collection) {
        this(config, config.getValueProjectionList(collection),
                cfg -> cfg.isUsingWhitelistValueProjection(collection),collection);
    }

    public WhitelistValueProjector(SinkConnectorConfig config, Set<String> fields,
