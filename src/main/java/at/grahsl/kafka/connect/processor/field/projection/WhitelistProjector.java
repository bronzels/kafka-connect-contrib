...
public abstract class WhitelistProjector extends FieldProjector {
    ...
    public WhitelistProjector(SinkConnectorConfig config, String collection) {
        this(config, config.getValueProjectionList(collection), collection);
    }

    public WhitelistProjector(SinkConnectorConfig config,
    ...
    protected void doProjection(String field, BsonDocument doc) {
        ...
        while(iter.hasNext()) {
            ...
            if(!fields.contains(key)
                    ...
                    && !key.equals(at.bronzels.libcdcdw.Constants.RK_4_MONGODB_AND_OTHER_DBS_ID_FIELD_NAME)) {
