...
public class MongoDbSinkTask extends SinkTask {
    ...
    public void start(Map<String, String> props) {
        ...
        remainingRetries = sinkConfig.getInt(
                MongoDbSinkConnectorConfig.MAX_NUM_RETRIES_CONF);
        deferRetryMs = sinkConfig.getInt(
                MongoDbSinkConnectorConfig.RETRIES_DEFER_TIMEOUT_CONF);
    ...
    public void put(Collection<SinkRecord> records) {
        ...
        batchMapping.forEach((namespace, batches) -> {
                    ...
                    String collection = StringUtils.substringAfter(namespace,
                            MongoDbSinkConnectorConfig.NAMESPACE_SEPARATOR);
    ...
    Map<String, SinkRecordBatches> createSinkRecordBatchesPerTopic(Collection<SinkRecord> records) {
        ...
        records.forEach(r -> {
            String collection = sinkConfig.getString(MongoDbSinkConnectorConfig.COLLECTION_CONF,r.topic());
            ...
            String namespace = database.getName()+ MongoDbSinkConnectorConfig.NAMESPACE_SEPARATOR +collection;
            ...
            if (batches == null) {
                int maxBatchSize = sinkConfig.getInt(MongoDbSinkConnectorConfig.MAX_BATCH_SIZE,collection);
