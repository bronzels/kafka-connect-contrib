...
public class ReplaceOneBusinessKeyStrategy implements WriteModelStrategy {
    ...
    public WriteModel<BsonDocument> createWriteModel(SinkDocument document) {
        ...
        BsonValue businessKey = vd.get(at.bronzels.libcdcdw.Constants.RK_4_MONGODB_AND_OTHER_DBS_ID_FIELD_NAME);
        ...
        vd.remove(at.bronzels.libcdcdw.Constants.RK_4_MONGODB_AND_OTHER_DBS_ID_FIELD_NAME);
