...
package at.bronzels.kafka.connect.kudu.cdc.debezium.rdbms.postgres;
...
public class PostgresHandler extends RdbmsHandler {
    ...
    public PostgresHandler(KuduSinkConnectorConfig config) {
        super(config);
    }

    public PostgresHandler(KuduSinkConnectorConfig config, Map<OperationType, CdcOperation> operations) {
