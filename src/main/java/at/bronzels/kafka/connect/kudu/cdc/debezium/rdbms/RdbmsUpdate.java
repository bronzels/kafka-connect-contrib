...
public class RdbmsUpdate implements CdcOperation {
    ...
    public Collection<Operation> perform(SinkDocument doc, MyKudu myKudu, boolean isSrcFieldNameWTUpperCase, Schema valueSchema) {
        ...
        try {
            BsonDocument updateDoc = RdbmsHandler.generateUpsertOrReplaceDoc(valueDoc);
           /* Map<String, Type> newCol2TypeMap = MyKuduTypeValue.getBsonCol2Add(myKudu.getName2TypeMap(), updateDoc, isSrcFieldNameWTUpperCase);
            ...
            Operation operation = KuduOperation.getOperation(OperationType.UPDATE, myKudu.getKuduTable(), updateDoc, isSrcFieldNameWTUpperCase);
