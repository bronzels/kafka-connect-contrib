package at.bronzels.kafka.connect.mongodb.cdc.debezium.rdbms;
...
public class RdbmsInsertTest {
    ...
    private void verifyResultsNoPK(BsonDocument valueDoc) {
        ...
        assertTrue(writeModel.getReplacement().isObjectId(at.bronzels.libcdcdw.Constants.RK_4_MONGODB_AND_OTHER_DBS_ID_FIELD_NAME),
                () -> "replacement doc must contain _id field of type ObjectID");

        replacementDoc.put(at.bronzels.libcdcdw.Constants.RK_4_MONGODB_AND_OTHER_DBS_ID_FIELD_NAME,
                writeModel.getReplacement().get(at.bronzels.libcdcdw.Constants.RK_4_MONGODB_AND_OTHER_DBS_ID_FIELD_NAME,new BsonObjectId()));
        ...
        assertTrue(((BsonDocument)writeModel.getFilter()).isObjectId(at.bronzels.libcdcdw.Constants.RK_4_MONGODB_AND_OTHER_DBS_ID_FIELD_NAME),
                () -> "filter doc must contain _id field of type ObjectID");

        filterDoc.put(at.bronzels.libcdcdw.Constants.RK_4_MONGODB_AND_OTHER_DBS_ID_FIELD_NAME,
                ((BsonDocument)writeModel.getFilter()).get(at.bronzels.libcdcdw.Constants.RK_4_MONGODB_AND_OTHER_DBS_ID_FIELD_NAME,new BsonObjectId()));
