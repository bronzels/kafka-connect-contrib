...
public class ValidatorWithOperatorsTest {
    ...
    final SinkConnectorConfig.ValidatorWithOperators PASS = (name, value) -> {
        // ignore, always passes
    };

    final SinkConnectorConfig.ValidatorWithOperators FAIL = (name, value) -> {
    ...
    public void emptyString() {
        SinkConnectorConfig.ValidatorWithOperators validator = MongoDbSinkConnectorConfig.emptyString();
    ...
    public void simpleRegex() {
        SinkConnectorConfig.ValidatorWithOperators validator = MongoDbSinkConnectorConfig.matching(Pattern.compile("fo+ba[rz]"));
